            ...
            {this.state.carss.map((car)=>
              {
                ...
                <TouchableOpacity style={{ width: 50, height: 30, borderWidth: 2 }}  onPress={()=>{ this.setState({ carrs: this.state.carss.splice(this.state.carss.indexOf(car), 1) }) }}><Text style={{textAlign:'center'}}><Icon name='trash' size={20}/></Text></TouchableOpacity>
                </ View>
                )
              }
              )}
